                                    ...
                                    <tbody>
                                        @foreach ($suppliers as $supplier)
                                            <tr>
                                                ...
                                                <td>
                                                    @if ($supplier->photo)
                                                        <img src="{{ asset('storage/' . $supplier->photo) }}" class="rounded-circle" width="50" height="50" alt="Foto">
                                                    @else
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-danger btn-sm delete-supplier" data-id="{{ $supplier->id }}">Eliminar</button>

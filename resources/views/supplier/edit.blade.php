                        ...
                        <div class="card-body p-4">
                            ...
                            <form action="{{ route('suppliers.update', $supplier) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="rut" id="rut" class="form-control" value="{{ $supplier->rut }}" required>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    @if($supplier->photo)
                                        <img src="{{ asset('storage/' . $supplier->photo) }}" alt="Foto del proveedor" class="img-thumbnail mt-2" width="100">
                                    @endif
                                </div>

    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('categories.index') }}" {{-- data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarDashboards" --}}>
                        <i class="ri-dashboard-2-line"></i> <span data-key="t-dashboards">Categorias</span>
                    </a>

                </li> <!-- end Dashboard Menu -->
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('products.index') }}" {{-- data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarApps" --}}>
                        <i class="ri-apps-2-line"></i> <span data-key="t-apps">Productos</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('customers.index') }}" {{-- data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts" --}}>
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Clientes</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('suppliers.index') }}" {{-- data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth" --}}>
                        <i class="ri-account-circle-line"></i> <span data-key="t-authentication">Proveedores</span>
                    </a>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('users.index') }}" {{-- data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarPages" --}}>
          ...
          {{--           <div class="collapse menu-dropdown" id="sidebarPages">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('purchases.index') }}" {{-- data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarLayouts" --}}>
                        <i class="ri-layout-3-line"></i> <span data-key="t-layouts">Listado</span>
                    </a>
                  {{--   <div class="collapse menu-dropdown" id="sidebarLayouts">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="{{ route('purchases.create') }}" {{-- data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="sidebarAuth" --}}>
                        <i class="ri-account-circle-line"></i> <span data-key="t-authentication">Nueva Compra</span>
                    </a>
                {{--     <div class="collapse menu-dropdown" id="sidebarAuth">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
